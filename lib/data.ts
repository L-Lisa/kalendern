...
export const EVENTS: CalendarEvent[] = [
  {
    id: "10",
    title: "Rekryteringsträff i Skärholmen",
    date: "2026-02-26",
    location: "Ekholmsvägen 34, Skärholmen",
    timeRange: "10:00–14:00",
    description:
      "Träffa arbetsgivare, skolor och utbildningsanordnare. Ingen föranmälan krävs. Kaffe och smörgås ingår. Arrangerat av Jobbtorg Stockholm.",
    tags: ["Jobbmässa"],
    isFree: true,
    ctaLabel: "Mer info",
    url: "https://socialtstod.stockholm/aktuellt/kalendarium/2026/02/rekryteringstraff-i-skarholmen",
  ...
  {
    id: "11",
    title: "Microsoft Reactor: Local AI Development with Foundry Local",
    date: "2026-03-02",
    location: "Online",
    timeRange: "17:00–18:00",
    description:
      "Lär dig köra AI-modeller lokalt med Foundry Local. Passar dig som vill förstå hur modern AI-infrastruktur fungerar och bygga praktiska färdigheter inför jobbmarknaden.",
    tags: ["Tech / IT"],
    isFree: true,
    ctaLabel: "Registrera",
    url: "https://www.meetup.com/microsoft-reactor-stockholm/events/313211888/",
    isOutsidePeriod: false,
    outsidePeriodLabel: null,
    targetAudience: null,
    status: "active",
  ...
  {
    id: "12",
    title: "Microsoft Reactor: Get Secure and Stay Secure in Agentic AI",
    date: "2026-03-03",
    location: "Online",
    timeRange: "19:00–20:00",
    description:
      "Praktisk genomgång av säkerhet i AI-drivet utvecklingsarbete med GitHub Advanced Security och Microsoft Defender. Gratis webbinar för alla nivåer.",
    tags: ["Tech / IT"],
    isFree: true,
    ctaLabel: "Registrera",
    url: "https://www.meetup.com/microsoft-reactor-stockholm/events/312466384/",
    isOutsidePeriod: false,
    outsidePeriodLabel: null,
    targetAudience: null,
    status: "active",
